...
#### Shards 3
``` js
rx@on7:/$ mongod --port 27014 --dbpath /data/shard3

2016-03-19T22:49:05.229-0300 I CONTROL  [initandlisten] MongoDB starting : pid=6750 port=27014 dbpath=/data/shard3 64-bit host=rxon7
...
``` js
rx@on7:/$ mongo --port 27011 --host localhost

MongoDB shell version: 3.2.4
connecting to: localhost:27011/test
Mongo-Hacker 0.0.13
rxon7:27011(mongos-3.2.4)[mongos] test>
...
### Replica 1
``` js
rx@on7:/$ mongod --replSet replica_set --port 27027 --dbpath /data/rs1

2016-03-19T22:55:31.401-0300 I CONTROL  [initandlisten] MongoDB starting : pid=6857 port=27027 dbpath=/data/rs1 64-bit host=rxon7
...
### Replica 2
``` js
rx@on7:/$ mongod --replSet replica_set --port 27028 --dbpath /data/rs2

2016-03-19T22:56:47.832-0300 I CONTROL  [initandlisten] MongoDB starting : pid=6890 port=27028 dbpath=/data/rs2 64-bit host=rxon7
...
### Replica 3
``` js
rx@on7:/$ mongod --replSet replica_set --port 27029 --dbpath /data/rs3

2016-03-19T22:57:44.507-0300 I CONTROL  [initandlisten] MongoDB starting : pid=6926 port=27029 dbpath=/data/rs3 64-bit host=rxon7
...
rxon7:27027(mongod-3.2.4) test> rs.initiate(rsconf)
{
  "ok": 1
}

rxon7:27027(mongod-3.2.4)[RECOVERING:replica_set] test> rs.add("127.0.0.1:27028")
{
  "ok": 1
}

rxon7:27027(mongod-3.2.4)[PRIMARY:replica_set] test> rs.add("127.0.0.1:27029")
{
  "ok": 1
}
```
